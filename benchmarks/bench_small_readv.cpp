...
int main(int argc,char**argv){const char* file=argc>1?argv[1]:"test.bin"; memtier_options_t o{};o.enable_dram_cache=1;o.cache_admit=1;o.chunk_size=1<<20;o.dram_cache_size=8<<20; memtier_ctx_t* c=nullptr; memtier_init(&o,&c);
