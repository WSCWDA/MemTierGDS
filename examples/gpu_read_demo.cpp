...
const char* path="memtier_gpu_demo.bin"; {std::ofstream ofs(path,std::ios::binary);std::vector<unsigned char>d(1<<20);for(size_t i=0;i<d.size();++i)d[i]=i%251;ofs.write((const char*)d.data(),d.size());}
