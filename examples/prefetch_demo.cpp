...
int main(){const char* path="memtier_prefetch_demo.bin";{std::ofstream ofs(path,std::ios::binary);std::vector<unsigned char>d(64<<20,9);ofs.write((const char*)d.data(),d.size());}
